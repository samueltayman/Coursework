...
**
**  Desc: This file contains the class definition for the MailHouse class. 
**  The MailHouse class runs the majority of the application including
**  creating Mail and Carrier objects, and deallocating memory
**
******************************************************************************/
